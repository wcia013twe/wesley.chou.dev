...
export const timelineData = [
  {
    ...
    overview:
      "I am currently a member of the UCF Upstarts Incubator program, \
      where I lead a team of four co-founders through the business validation process for a software product, \
  ...
  },
  {
    ...
    overview:
      "I am currently an undergraduate researcher at the UCF College of Optics and Photonics, \
      where I work on deep learning applications and geometrical modeling of gaze tracking algorithms \
      , aiming to optimize foveated rendering in augmented reality technologies.",
    key_responsibilities: [
