...
const NODES = [
  {
    ...
    detail: "Languages that I build with",
    skills: [
      ...
      {
        name: "C",
        icon: <CustomIcon title="C" src="/icons/C_Programming_Language.svg.png" size={26} />,
      },
      // { name: "SQL", icon: <StackIcon name="sql" /> },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "LangChain", icon: <StackIcon name="langchain" variant="dark" /> },
       {
        name: "OpenCV",
        icon: <CustomIcon title="C" src="/icons/ocv.png" size={26} />,
      },
      {
        name: "Pinecone",
        icon: <CustomIcon title="C" src="/icons/Pinecone-Icon-Logo-Vector.svg-.png" size={26} />,
      },
      { name: "PyTorch", icon: <StackIcon name="pytorch" /> },
    ] as SkillIcon[],
  },
  {
    id: "wing",
    ...
    skills: [
      ...
      { name: "TypeScript", icon: <StackIcon name="typescript" /> },
      { name: "Three.js", icon: <StackIcon name="threejs" variant="dark"/> },
      { name: "Next.js", icon: <StackIcon name="nextjs" variant="dark" /> },
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "FastAPI",
        icon: <CustomIcon title="FastAPI" src="/icons/fastapi.png" size={26} />,
      },
      { name: "Express", icon: <StackIcon name="expressjs" variant="dark"/> },
      { name: "Supabase", icon: <StackIcon name="supabase" /> },
      { name: "Firebase", icon: <StackIcon name="firebase" /> },
      { name: "PostgresSQL", icon: <StackIcon name="postgresql" /> },
...
function computeCardInfo(
  ...
  const y = Math.max(
    CARD_PAD,
    Math.min(cy - CARD_H_EST / 2, ch - CARD_H_EST - CARD_PAD),
  );
  return {
    x,
    y,
      ...
      >
        ...
        <div
          style={{
            ...
            boxShadow:
              "0 0 0 1px rgba(34,211,238,0.07), 0 12px 48px rgba(0,0,0,0.85)",
            position: "relative",
          }}
        >
          {/* Corner accents */}
          ...
          <span
            style={{
              ...
              height: "1px",
              width: "44px",
              background: "linear-gradient(270deg,#22d3ee,transparent)",
            }}
          />
          <span
            style={{
              ...
              width: "1px",
              height: "30px",
              background: "linear-gradient(0deg,#22d3ee,transparent)",
            }}
          />
          ...
          <div style={{ padding: "16px 18px 14px" }}>
            ...
            >
              ...
              <button
                ...
                onMouseLeave={(e) =>
                  (e.currentTarget.style.color = "rgba(34,211,238,0.50)")
                }
              >
                ✕
              </button>
            ...
            <motion.div
              style={{
                height: "1px",
                background:
                  "linear-gradient(90deg,rgba(34,211,238,0.45),transparent)",
                marginBottom: 10,
              }}
            ...
            {node.skills.some((s) => s.icon) ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
                {node.skills.map((skill, i) => (
                  ...
                  >
                    <span
                      style={{ color: "rgba(34,211,238,0.40)", marginRight: 6 }}
                    >
                      {">"}
                    </span>
                    {skill.name}
...
function buildChip(node: (typeof NODES)[0]) {
  ...
  t.style.cssText =
    "font-family:ui-monospace,monospace;font-size:12px;font-weight:600;letter-spacing:.06em;color:#67e8f9;margin:0 0 1px;white-space:nowrap;text-shadow:0 0 8px rgba(34,211,238,.55);";
  t.textContent = node.title;
  const r = document.createElement("p");
  r.style.cssText =
    "font-family:ui-monospace,monospace;font-size:9px;letter-spacing:.16em;color:rgba(34,211,238,.48);margin:0;white-space:nowrap;";
...
export default function SpaceshipDiagram() {
  ...
  useEffect(() => {
    ...
    const bloom = new UnrealBloomPass(new THREE.Vector2(w, h), 0.8, 0.5, 0.2);
    ...
    let lastDragX = 0,
      lastDragY = 0;
    const AUTO_ROT_SPEED = 0.08; // radians/s
